...
See [notebook](./notebooks/imapose2vizgen/_template_scratch_imapose2vizgen.ipynb) for converting Imaris puncta detection output and Cellpose segmentation into Vizgen-compatible formats for downstream analysis.
